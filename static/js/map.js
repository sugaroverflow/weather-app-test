...
// API Keys for testing, replace with env after testing
const weatherSecret = 'fda1c6e62c8bd74af4911263004f4b54';
const mapboxSecretToken = 'pk.eyJ1Ijoic3VnYXJvdmVyZmxvdyIsImEiOiJjbWFicmVmMWwwN2NmMnNvZ3Q3OXYyNmppIn0.SRF6ui8AZlt-edmUrKoNVR';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    map.on('load', function () {
        setTimeout(function () {
            ...
            loadWeatherLayers(-73.9857, 40.7484, weatherSecret);
        }, 100);
    });
    ...
    layerButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            if (map && map.isStyleLoaded() && window.lastSearchedCoords) {
                ...
                const apiKey = window.currentApiKey || weatherSecret;
...
async function showRegionalWeather(lat, lon, apiKey) {
    try {
        ...
        window.currentApiKey = apiKey || weatherSecret;
